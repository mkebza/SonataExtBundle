...
class UserAdmin extends AbstractAdmin
{
    ...
    public function preUpdate($object)
    {
        ...
        $this->getConfigurationPool()->getContainer()->get('monolog.logger.app_action')->error('Muj super error', ['references' => $object]);
    }
        ...
        return [
            self::class => [
                [
                    'actions' => ['edit'],
                    'items' => [
                        $this->createTabMenuItem('Log', 'admin_user_log_list', ['id'], 'bars'),
                    ],
                ],
            ],
